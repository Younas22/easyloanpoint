...
@section('page-header')
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-xl font-bold text-gray-900">Add HR Member</h1>
            <p class="mt-0.5 text-sm text-gray-500">Create a new HR account.</p>
        </div>
    </div>
@endsection
        ...
        <div class="space-y-5 px-6 py-6">
            ...
            <div>
                ...
                <div class="flex items-center gap-4">
                    <div id="img-preview"
                         class="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-full border-2 border-dashed border-gray-300 bg-gray-50 text-gray-400 overflow-hidden">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="mt-1.5 text-xs text-gray-400">JPG, JPEG or PNG. Max 2MB.</p>
                    </div>
                </div>
                @error('profile_image')
